...
public class FormPage6 {
	...
	public FormPage6(int qNo, Connection con) {
	...
	void MakeParamPanel() {
		...
		goButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String merchandise = paramField1.getText();
				String town = paramField2.getText();
				
				String[][] dataMatrix = RetrieveData( merchandise, town );
		...
		JLabel paramLabel1 = new JLabel("Enter merchandise:", SwingConstants.LEFT);
		JLabel paramLabel2 = new JLabel("Enter town:", SwingConstants.LEFT);
	...
	public String[][] RetrieveData( String merchandise, String town ) {
		DataFetch d = new DataFetch();
		System.out.println("Fetching data");
		String s1 = "SELECT artist.ArtistID, ArtistName, ArtistScore, website.WebsiteName, NextEventDate FROM artist join OwnsWebsite join website ";
		String s2 = "where OwnsWebsite.ArtistID = artist.ArtistID and  ";
		String s3 = "website.WebsiteName = OwnsWebsite.WebsiteName";
		String s4 = " and website.Merchandise = \"" + merchandise + "\"" + " and artist.Hometown = \"" + town + "\"";
		String s5 = " order by artist.ArtistScore desc;";
