...
public class FormPage12 {
	...
	public FormPage12(int qNo, Connection con) {
	...
	public String[][] RetrieveData() {
		...
		queryString ="SELECT S.SongName,S.SongScore\n" + 
				"FROM song S\n" + 
				"WHERE S.SongID  IN ( SELECT DISTINCT S1.SongID FROM song S1 )\n" + 
				"AND S.SongScore > ( SELECT AVG (A2.AlbumScore)\n" + 
				"FROM album A2\n" + 
				"WHERE A2.AlbumID IN ( SELECT DISTINCT A1.AlbumID FROM album A1 ) )";
	...
	JPanel MakeDescription() {
		...
		JLabel songLabel = new JLabel("Current Query : 12. Songs with rating greater than avg rating of all albums.", SwingConstants.CENTER);
