...
//		exitButton.setPreferredSize(new Dimension(5,40));
	...
	void MakeQueryPanel()
	{
       ...
       Border blackline = BorderFactory.createStrokeBorder(new BasicStroke(5.0f));
        ...
        //QueryPanel.setBorder(BorderFactory.createTitledBorder(null, "HOME", TitledBorder.CENTER, TitledBorder.ABOVE_TOP, new Font("times new roman",Font.PLAIN,12), Color.black));
