...
public class FormPage5 {
	...
	public FormPage5(int qNo, Connection con) {
	...
	JPanel MakeDescription() {
		...
		JLabel songLabel = new JLabel("Current Query : 5. Top n songs of a particular genre.", SwingConstants.CENTER);
