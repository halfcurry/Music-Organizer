...
public class FormPage4 {
	...
	public FormPage4(int qNo, Connection con) {
	...
	void MakeParamPanel() {
		...
		goButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int n = Integer.parseInt(paramField1.getText());
				String code = paramField2.getText();

				String[][] dataMatrix = RetrieveData(n, code);
		...
		JLabel paramLabel2 = new JLabel("Enter US/Eur:", SwingConstants.LEFT);
	...
	public String[][] RetrieveData(Integer n, String code) {
		DataFetch d = new DataFetch();
		System.out.println("Fetching data");
		if (code.equals("US")) {
			String s1 = "SELECT song.SongID,artist.ArtistName, song.SongName, USA_Score FROM performs join song ";
			String s2 = "join artist on performs.ArtistID = artist.ArtistID and performs.SongID = song.SongID ";
			String s3 = "order by USA_Score desc limit " + n +";";
			queryString = s1+s2+s3;
		}
		else{
			String s1 = "SELECT song.SongID,artist.ArtistName, song.SongName, Eur_score FROM performs join song ";
			String s2 = "join artist on performs.ArtistID = artist.ArtistID and performs.SongID = song.SongID ";
			String s3 = "order by Eur_score desc limit " + n +";";
			queryString = s1+s2+s3;
		}
	...
	JPanel MakeDescription() {
		...
		JLabel songLabel = new JLabel("Current Query : 4. Top n songs in US/Eur.", SwingConstants.CENTER);
