...
public class FormPage14 {
	...
	public FormPage14(int qNo, Connection con) {
	...
	void MakeParamPanel() {
		...
		goButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String date = paramField1.getText();
				
				String[][] dataMatrix = RetrieveData( date );
		...
		JLabel paramLabel1 = new JLabel("Enter date:", SwingConstants.LEFT);
	...
	public String[][] RetrieveData( String date ) {
		DataFetch d = new DataFetch();
		System.out.println("Fetching data");
		queryString = "SELECT artist.ArtistID, artist.ArtistName, Hometown, NextEventDate from artist join OwnsWebsite join website\n" + 
				"where artist.ArtistID = OwnsWebsite.ArtistID and website.WebsiteName = OwnsWebsite.WebsiteName\n" + 
				"and NextEventDate <= \"" + date + "\"";
	...
	JPanel MakeDescription() {
		...
		JLabel songLabel = new JLabel("Current Query : 14. Artists who are performing within some date.", SwingConstants.CENTER);
