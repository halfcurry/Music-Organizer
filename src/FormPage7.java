...
public class FormPage7 {
	...
	public FormPage7(int qNo, Connection con) {
	...
	void MakeParamPanel() {
		...
		JLabel paramLabel1 = new JLabel("Enter Genre:", SwingConstants.LEFT);
		JLabel paramLabel2 = new JLabel("Enter Size:", SwingConstants.LEFT);
	...
	public String[][] RetrieveData( String genre, Integer size ) {
		DataFetch d = new DataFetch();
		System.out.println("Fetching data");
		String s1 = "select song.SongID, song.ArtistName, song.SongName, FileExtension, BitRate_KB, Size_MB, Duration_Sec from song join BelongstoGenre join Genre join audiospecs ";
		String s2 = "where song.SongID = BelongstoGenre.SongID and  ";
		String s3 = "BelongstoGenre.GenreID = Genre.GenreID ";
		String s4 = "and song.SongID = audiospecs.SongID";
		String s5 = " and Genre.GenreName = \"" + genre + "\"";
		String s6 = " and audiospecs.Size_MB <" + size + ";";
		queryString = s1 + s2 + s3 + s4 + s5 + s6;
	...
	JPanel MakeDescription() {
		...
		JLabel songLabel = new JLabel("Current Query : 7. Songs of a particular genre with size less than x mb.", SwingConstants.CENTER);
