...
//	DefaultTableModel resultTable;
	...
	public FormPage(int qNo,String queryString)
	{
	...
	{
		SQLConnector con1= new SQLConnector();
		 ArrayList<ArrayList<String>>  dataArrayList =con1.ConnectToServer(queryString);
...
//		System.out.println(dataMatrix[0][1]);
	...
	void MakeTable()
	{
       ...
       String[] columnNames = {"equipID",
    		    "name",
    		    "date",
    		    };
       DefaultTableModel resultTable = new DefaultTableModel(columnNames, 0);  	
